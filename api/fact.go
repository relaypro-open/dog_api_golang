...
func (c *Client) UpdateFact(FactID string, FactUpdate Fact, options *FactListOptions) (fact Fact, statusCode int, Error error) {
...
func (c *Client) CreateFact(factNew Fact, options *FactListOptions) (fact Fact, statusCode int, Error error) {
